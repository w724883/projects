    ...
    var Index = {
        init:function(){
            ...
            this.touchSlider = TouchSlider({
                ...
                before:function(i){
                    Index.pagination.find('.pagination').removeClass('active').eq(i).addClass('active');
                }
            });
            this.setPagination();
        },
        setPagination:function(){
            ...
            for (var i = 0; i < lis.length; i++) {
                if(i == 0){
                    paginationRender += '<span class="pagination active"></span>';
                    continue;
                }
                paginationRender += '<span class="pagination"></span>';
            };
