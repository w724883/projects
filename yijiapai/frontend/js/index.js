...
$(function(){
    var Index = {
        init:function(){
            // var $indexItems = $('#indexItems');
            // var $lis = $indexItems.find('li');
            // for (var i = $lis.length - 1; i >= 0; i--) {
            //     i%3 == 0 && $lis.eq(i).addClass('item-first');
            //     i%3 == 2 && $lis.eq(i).addClass('item-last');
            // };
            ...
            require('/center').center($("#indexFocus"));
            this.setPagination();
        ...
        bindEvent:function(){
            ...
            var $indexItems = $('#indexItems');
            var indexItemsTop = $indexItems.offset().top-300;
            ...
            $(window).on('scroll',function(e){
                ...
                if($(window).width() > $indexItems.width() + 60){
